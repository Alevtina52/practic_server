...
//Создаем класс для аутентификации на основе настроек

$this->auth = new $this->settings->app['auth'];
//Настройка для работы с базой данных
$this->dbRun();
//Инициализация класса пользователя на основе настроек
...
$this->auth::init(new $this->settings->app['identity']);
    ...
    private function dbRun()
    {
        ...
        $this->dbManager->setEventDispatcher(new Dispatcher(new
        Container));
